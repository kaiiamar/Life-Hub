...
function renderPage(page){if(page==='dashboard')renderDashboard();if(page==='goals')renderGoals();if(page==='habits')renderHabits();if(page==='workout')renderWorkout();if(page==='finance')renderFinance('plan');if(page==='review')renderReview();if(page==='insights')renderInsights();if(page==='relationships')renderRelationships();if(page==='gratitude')renderGratitude();if(page==='lists'){renderWatchlist();renderWishlist()}if(page==='skincare')renderSkincare();if(page==='tasks')renderTasksArchive()}
