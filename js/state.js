...
var DEFAULT_STATE = {
  goals:[
    ...
    {id:g(),name:'Thailand anniversary trip',cat:'Personal',badge:'per',desc:'29 November 2026 \u2014 2-year anniversary trip with REDACTED',target:100,unit:'%',direction:'up',deadline:'2026-11-29',progress:5,subGoals:[]},
  ],
  habits:[
  ...
  prs:{},
  income:[{id:'inc1',name:'REDACTED',amount:2400,icon:'\ud83d\udcbc',note:'After tax'}],
  expenses:[
  ...
  accounts:[
    {id:'acc1',name:'Stocks and Shares ISA',type:'savings',balance:2400,color:'#a0522d',icon:'\ud83d\udcc8',institution:'REDACTED'},
    {id:'acc2',name:'Lifetime ISA',type:'savings',balance:250,color:'#c9973a',icon:'\ud83c\udfe0',institution:'REDACTED',target:4000,note:'House deposit'},
  ],
  debts:[
    {id:'dbt1',name:'REDACTED',balance:1200,priority:'High',color:'#f43f5e',note:''},
    {id:'dbt2',name:'REDACTED',balance:257,priority:'Medium',color:'#fb7185',note:''},
    {id:'dbt3',name:'REDACTED',balance:0,priority:'Low',color:'#fda4af',note:''},
    {id:'dbt4',name:'REDACTED - Very',balance:35,priority:'Low',color:'#fda4af',note:''},
    {id:'dbt5',name:'REDACTED',balance:100,priority:'High',color:'#f43f5e',note:''},
    {id:'dbt6',name:'Very',balance:100,priority:'High',color:'#f43f5e',due:'2026-06-28',note:''},
    {id:'dbt7',name:'REDACTED',balance:800,priority:'Low',color:'#fda4af',note:'Pay in 3'},
    {id:'dbt8',name:'REDACTED',balance:100,priority:'Low',color:'#fda4af',note:'Auto Payments'},
    {id:'dbt9',name:'REDACTED',balance:3900,priority:'Medium',color:'#fb7185',note:''},
  ],
  savingsGoals:[
